...
The Bootstrap source code download includes the precompiled CSS and JavaScript static, along with source Sass, JavaScript, and documentation. More specifically, it includes the following and more:
